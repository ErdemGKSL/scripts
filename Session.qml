            ...
            ColumnLayout { // Content column
                ...
                GridLayout {
                    ...
                    SessionActionButton {
                        ...
                        KeyNavigation.down: sessionRebootWindows
                    }
                    ...
                    SessionActionButton {
                        ...
                        KeyNavigation.right: sessionRebootWindows
                    }

                    SessionActionButton {
                        id: sessionRebootWindows
                        buttonIcon: "window"
                        buttonText: qsTr("Reboot to Windows")
                        onClicked: {
                            Quickshell.execDetached(["bash", "-c", `sudo grub-reboot "Windows Boot Manager (on /dev/nvme0n1p1)" && reboot`]);
                            sessionRoot.hide()
                        }
                        onFocusChanged: { if (focus) sessionRoot.subtitle = buttonText }
